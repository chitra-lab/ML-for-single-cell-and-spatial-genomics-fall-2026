...
| 9/22 | 7 | Deep dimensionality reduction: AE + VAE |  |
...
| 10/6 | 11 | Manifold learning / graphs 2: random walks |  |
...
| 10/20 | 15 | Graph clustering + GNNs | **Quiz 3** |
| 10/22 |  | **NO CLASS: Fall break** | **Oral Exam 1 (date TBD)** |
| 10/27 | 16 | Graph methods (cont.) + spatial methods: SVGs, neural fields, and point processes (segmentation) |  |
| 10/29 | 17 | Spatial methods (cont.) + in-class lab | **Lab 4 in class (Report due 11/2)** |
